...
impl<OS, S> From<super::Hsi<OS>> for Hsv<S>
where
  OS: RgbSpec,
  S: RgbSpec,
{
...
#[cfg(feature = "space-hsluv")]
impl<S> From<Hsluv> for Hsv<S>
where
  S: RgbSpec,
{
  fn from(hsluv: Hsluv) -> Self {
    hsluv.to_rgb::<S>().to_hsv()
  }
}

#[cfg(feature = "space-hpluv")]
impl<S> From<Hpluv> for Hsv<S>
where
  S: RgbSpec,
{
  fn from(hpluv: Hpluv) -> Self {
    hpluv.to_rgb::<S>().to_hsv()
  }
}
...
#[cfg(feature = "space-lchuv")]
impl<S> From<Lchuv> for Hsv<S>
where
  S: RgbSpec,
{
  fn from(lchuv: Lchuv) -> Self {
    lchuv.to_rgb::<S>().to_hsv()
  }
}
...
#[cfg(feature = "space-okhsl")]
impl<S> From<Okhsl> for Hsv<S>
where
  S: RgbSpec,
{
  fn from(okhsl: Okhsl) -> Self {
    okhsl.to_rgb::<S>().to_hsv()
  }
}

#[cfg(feature = "space-okhsv")]
impl<S> From<Okhsv> for Hsv<S>
where
  S: RgbSpec,
{
  fn from(okhsv: Okhsv) -> Self {
    okhsv.to_rgb::<S>().to_hsv()
  }
}

#[cfg(feature = "space-okhwb")]
impl<S> From<Okhwb> for Hsv<S>
where
  S: RgbSpec,
{
  fn from(okhwb: Okhwb) -> Self {
    okhwb.to_rgb::<S>().to_hsv()
  }
}

#[cfg(feature = "space-oklab")]
impl<S> From<Oklab> for Hsv<S>
where
  S: RgbSpec,
{
  fn from(oklab: Oklab) -> Self {
    oklab.to_rgb::<S>().to_hsv()
  }
}

#[cfg(feature = "space-oklch")]
impl<S> From<Oklch> for Hsv<S>
where
  S: RgbSpec,
{
  fn from(oklch: Oklch) -> Self {
    oklch.to_rgb::<S>().to_hsv()
  }
}
