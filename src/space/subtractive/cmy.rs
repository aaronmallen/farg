...
#[cfg(feature = "serde")]
impl<'de, S> serde::Deserialize<'de> for Cmy<S>
where
  S: RgbSpec,
{
  fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
    ...
    let data = CmyData::deserialize(deserializer)?;
    Ok(Self {
      c: data.c,
      m: data.m,
      y: data.y,
...
#[cfg(feature = "space-hpluv")]
impl<S> From<Hpluv> for Cmy<S>
where
  S: RgbSpec,
{
  fn from(hpluv: Hpluv) -> Self {
    hpluv.to_rgb::<S>().to_cmy()
  }
}

#[cfg(feature = "space-hsi")]
impl<OS, S> From<Hsi<OS>> for Cmy<S>
where
  OS: RgbSpec,
  S: RgbSpec,
{
...
#[cfg(feature = "space-hsluv")]
impl<S> From<Hsluv> for Cmy<S>
where
  S: RgbSpec,
{
  fn from(hsluv: Hsluv) -> Self {
    hsluv.to_rgb::<S>().to_cmy()
  }
}
...
#[cfg(feature = "space-lchuv")]
impl<S> From<Lchuv> for Cmy<S>
where
  S: RgbSpec,
{
  fn from(lchuv: Lchuv) -> Self {
    lchuv.to_rgb::<S>().to_cmy()
  }
}
...
#[cfg(feature = "space-okhwb")]
impl<S> From<Okhwb> for Cmy<S>
where
  S: RgbSpec,
{
  fn from(okhwb: Okhwb) -> Self {
    okhwb.to_rgb::<S>().to_cmy()
  }
}
...
#[cfg(feature = "serde")]
impl<S> serde::Serialize for Cmy<S>
where
  S: RgbSpec,
{
  fn serialize<Ser: serde::Serializer>(&self, serializer: Ser) -> Result<Ser::Ok, Ser::Error> {
    ...
    let mut state = serializer.serialize_struct("Cmy", field_count)?;
